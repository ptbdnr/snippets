...
# HostName can be found by navigating to your discovery_url
# and removing the leading "https://" and trailing "/discovery"
# To find your discovery_url, run the CLI command:
# az ml workspace show -n {project_name} --resource-group {resource_group_name} --query discovery_url
# Project Connection example:
# eastus.api.azureml.ms;12345678-abcd-1234-9fc6-62780b3d3e05;my-resource-group;my-project-name
# Customer needs to login to Azure subscription
# via Azure CLI and set the environment variables
...
with project_client:
    ...
    message = project_client.agents.create_message(
        ...
        role="user",
        content=(
            "Could you please create a bar chart for the operating profit"
            " using the following data and provide the file to me?"
